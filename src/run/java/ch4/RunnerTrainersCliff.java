...
public class RunnerTrainersCliff {
    ...
    private static void plot() {
        showAndSavePlots(dependencies.qlearning(), trainers.qlearning().getRecorder(), "_QlearningCliff", NOF_DIGITS);
        showAndSavePlots(dependencies.sarsa(), trainers.sarsa().getRecorder(), "_sarsaCliff", NOF_DIGITS);
    }
