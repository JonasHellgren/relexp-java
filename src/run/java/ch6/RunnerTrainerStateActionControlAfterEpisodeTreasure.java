...
public class RunnerTrainerStateActionControlAfterEpisodeTreasure {
    ...
    public static void main(String[] args) {
        ...
        showAndSavePlots(dependencies, trainer.getRecorder(), "_treasure_after_episode", 0);
    }

    private static TrainerStateActionControlAfterEpisode defineTrainer() {
        var dependencies= TrainerDependenciesFactoryTreasure.treasure(
