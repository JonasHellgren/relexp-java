...
public class RunnerPendulumAnimation {
    ...
    public static void main(String[] args) {
        var dependencies = TrainerDependenciesFactory.createForAnimation(HYPER_PAR);
        ...
        trainer.train(AnimationPendulum.create(cfg, getEnv(dependencies)));
        trainer.logTime();
        plotting(trainer, dependencies, evaluator);
    }


    private static EnvironmentPendulum getEnv(TrainerDependencies trainerDependencies) {
        return trainerDependencies.environment();
    }
