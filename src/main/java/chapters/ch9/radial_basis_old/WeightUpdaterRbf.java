...
public class WeightUpdaterRbf {
    double learningRate;

    public static WeightUpdaterRbf of(double learningRate) {
        return new WeightUpdaterRbf(learningRate);
    }
    ...
    private static void validate(TrainDataOld data, Weights weights, Activations activations) {
        ...
        Preconditions.checkArgument(data.isErrors(), "data should be of type including errors");
    }
