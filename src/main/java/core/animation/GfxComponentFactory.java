...
public class GfxComponentFactory {
    ...
    public void addLineChart(
        ...
        ChartAndPanelSizeSetter.setXaxisRange(chart, xlabel, xRange, getLabelFont(settings.fontsizeAxis()));
        ChartAndPanelSizeSetter.setYaxisRange(chart, ylabel, yRange, getLabelFont(settings.fontsizeAxis()));
        lineCharts.add(chart);
        var panel = new ChartPanel(chart);
        ChartAndPanelSizeSetter.setSizePanel(panel, settings.panelWidth(), settings.panelHeight());
    ...
    public void addTable(String[] columnNames, boolean showGrid) {
        ...
        ChartAndPanelSizeSetter.setTable(panel, settings.tableWidth(), settings.tableHeight());
        tableModels.add(tm);
