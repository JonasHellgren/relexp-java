package core.plotting_core.plotting_3d;
...
import static core.foundation.util.collections.MyMatrixArrayUtil.findMax;
import static core.foundation.util.collections.MyMatrixArrayUtil.findMin;
...
public class HeatMapChartCreator {
    ...
    public static HeatMapChartCreator of(PlotSettings settings, double[][] data, double[] xData, double[] yData) {
        return new HeatMapChartCreator(
                settings,
                data,
                ArrayUtil.doubleToInteger(xData),
                ArrayUtil.doubleToInteger(yData));
    }
    ...
    protected void validate() {
        ...
        ConditionalsUtil.executeIfTrue(settings.showAxisTicks() && manyRowsOrColumns(), () ->
                log.warning("To many rows or columns for axis ticks "));
        ConditionalsUtil.executeIfTrue(settings.showDataValues() && manyRowsOrColumns(), () ->
...
*/
    ...
    private static double[] getDataExt(int[] axisData) {
        ...
        return ArrayCreatorUtil.createArrayInRange(min, step, max+step);
    }
