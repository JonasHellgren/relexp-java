...
import core.foundation.util.collections.MatrixArrayCreatorUtil;
...
public class HeatMapWithStringTextInCellsCreator extends HeatMapChartCreator {
    ...
    public HeatMapWithStringTextInCellsCreator(
        ...
        super(settings, data, ArrayUtil.doubleToInteger(xData0), ArrayUtil.doubleToInteger(yData0));
    ...
    public static HeatMapWithStringTextInCellsCreator ofStringData(
        ...
        double[][] data = MatrixArrayCreatorUtil.createAllZeroMatrix(stringData.length);
    ...
    public static HeatMapWithStringTextInCellsCreator ofStringData(PlotSettings settings, String[][] stringData) {
        ...
        return ofStringData(settings,
                stringData,
                ArrayCreatorUtil.createArrayFromStartAndEnd(nCols, 0, nCols),
                ArrayCreatorUtil.createArrayFromStartAndEnd(nRows, 0, nRows));
    }
