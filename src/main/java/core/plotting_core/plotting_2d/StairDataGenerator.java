...
public final class StairDataGenerator {
    ...
    public static Pair<List<Double>, List<Double>> generateWithEndStepList(Pair<List<Double>, List<Double>> xyData) {
        return generateWithEndStep(Pair.create(List2ArrayConverterUtil.convertListToDoubleArr(xyData.getFirst()),
                List2ArrayConverterUtil.convertListToDoubleArr(xyData.getSecond())));
    }
