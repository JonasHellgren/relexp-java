...
public class UnitConverterUtil {
    ...
    public static Function<Double, Double> w2kw = (p) ->
            UnitConverterUtil.convertPower(p, Units.WATT, NonSIUnitsUtil.KILO_WATT);
    ...
    public static Function<Double, Double> kw2w = (p) ->
            UnitConverterUtil.convertPower(p, NonSIUnitsUtil.KILO_WATT,Units.WATT);
    ...
    public static double min2sec(double timeInMin) {
        return UnitConverterUtil.convertTime(timeInMin, Units.MINUTE, Units.SECOND);
    }

    public static double sec2min(double timeInSec) {
        return UnitConverterUtil.convertTime(timeInSec, Units.SECOND, Units.MINUTE);
    }
    ...
    public static  List<Double> list2kw(List<Double> powerTraj) {
        return powerTraj.stream().map(p -> UnitConverterUtil.w2kw.apply(p)).toList();
    }
    ...
    public static  List<Double> listToPercent(List<Double> values) {
        return values.stream().map(p -> UnitConverterUtil.toPercent.apply(p)).toList();
    }
